...
exports.validateWorkflowsForAction = validateWorkflowsForAction;
    ...
    validate() {
        ...
        for (const workflowFile of workflowFiles) {
            ...
            if (content.includes('jrschumacher/go-actions/release@')) {
                ...
                const releasePleaseValidator = new release_please_validator_1.ReleasePleaseValidator(this.workingDir);
                ...
                for (const rpError of releasePleaseResult.errors) {
                    errors.push({
                        type: rpError.type, // These types are compatible
...
async function validateWorkflowsForAction(workingDir = '.', workflowPaths = '.github/workflows/*.yaml,.github/workflows/*.yml', commentOnPr = true) {
...
async function default_1(workingDir = '.') {
